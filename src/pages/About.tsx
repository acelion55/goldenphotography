...
const About = () => {
  ...
  return (
    <>
      <SEO
        title="About Golden Photography | Best Photographer in Beawar, Ajmer, Jodhpur, Jaipur, Pali, Rajasthan"
        description="Golden Photography – Best photographer in Beawar, Ajmer, Jodhpur, Jaipur, Pali, Rajasthan. Best wedding photographer & best pre wedding photographer in Rajasthan. Know more about us."
        canonicalUrl="/about"
      />
