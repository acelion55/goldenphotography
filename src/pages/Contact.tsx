...
const Contact = () => {
  ...
  return (
    <>
      <SEO
        title="Contact - Golden Photography, Beawar"
        description="Get in touch with Golden Photography for wedding, event, and portrait photography in Beawar, Rajasthan."
